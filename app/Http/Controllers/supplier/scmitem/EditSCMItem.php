...
class EditSCMItem extends BaseAdminController
{
    /**
    ...
    public function __invoke($itemId, EditItemSupplierRequest $request)
    {
        ...
        return redirect(route('scmitem'))->with('result', ['tabactive' => 'tab1','message' => 'Cập nhật thành công hạng mục!']);
    }
}
